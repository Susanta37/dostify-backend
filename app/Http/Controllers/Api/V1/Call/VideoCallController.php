...
class VideoCallController extends Controller
{
    ...
    public function initiate(Request $request): JsonResponse
    {
        ...
        $session = $this->calls->initiateVideo($request->user(), $callee);
    ...
    {
        $request->validate(['call_uuid' => ['required', 'uuid', 'exists:video_sessions,uuid']]);

        $session = $this->calls->acceptVideo($request->user(), $request->input('call_uuid'));
    ...
    public function reject(Request $request): JsonResponse
    {
        ...
        $session = $this->calls->rejectVideo($request->user(), $request->input('call_uuid'));
    ...
    public function end(Request $request): JsonResponse
    {
        ...
        $session = $this->calls->endVideo($request->user(), $request->input('call_uuid'));
    ...
    {
        return response()->json([
            'calls' => CallSessionResource::collection($this->calls->videoHistory($request->user())),
        ]);
    }
}
